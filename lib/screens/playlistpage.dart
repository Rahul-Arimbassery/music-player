    ...
    if (!deletePressed) {
      if (pagestatus != true) {
        if (!indexesPlaylist.contains(playlistIndex)) {
          indexesPlaylist.add(
              playlistIndex); // Add playlistIndex if it doesn't already exist

          Fluttertoast.showToast(
            msg: 'Song Added to Playlist Sucessfully!!!',
      ...
      if (pagestatus == true) {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) =>
                PlaylistDetailPage(playlistName: playlistNames[index]),
          ),
        );
      }
    } else {
                          ...
                          children: [
                            Expanded(
                              child: Padding(
                                ...
                                child: Center(
                                    child:
                                        _buildPlaylistContainer(startIndex)),
                              ),
                            ),
                            Expanded(
                              child: Padding(
